    ...
    public static class Job extends Writer.Job {
        ...
        private void validateParameter() {
            ...
            if( !fileType.equalsIgnoreCase("ORC") && !fileType.equalsIgnoreCase("TEXT")
                    &&!fileType.equalsIgnoreCase("RC")){
                String message = "HdfsWriter插件目前只支持ORC,TEXT,RC三种格式的文件,请将filetype选项的值配置为ORC,TEXT,RC";
        ...
        public void startWrite(RecordReceiver lineReceiver) {
            ...
            if(fileType.equalsIgnoreCase("TEXT")){
                ...
                hdfsHelper.orcFileStartWrite(lineReceiver,this.writerSliceConfig, this.fileName,
                        this.getTaskPluginCollector());
            }else if(fileType.equalsIgnoreCase("RC")){
                //写RC FILE
                hdfsHelper.rcFileStartWrite(lineReceiver,this.writerSliceConfig, this.fileName,
                        this.getTaskPluginCollector());
            }
